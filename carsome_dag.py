...
scrape_task = BashOperator(
    ...
    bash_command='python3 /path/to/carsome_scrape.py',
    dag=dag
)
...
etl_task = BashOperator(
    task_id='carsome_etl',
    bash_command='python3 /path/to/carsome_etl.py',
    dag=dag
)
...
brand_country_task = BashOperator(
    ...
    bash_command='python3 /path/to/brand_country.py',
    dag=dag
)
...
merge_task = BashOperator(
    ...
    bash_command='python3 /path/to/merge_dataframes.py',
    dag=dag
)
